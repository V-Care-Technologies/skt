...
<div class="inner-main-content">   
    ...
    <div class="row align-items-center search_main_row mb-3">
        ...
        <div class="col-xl-9 col-md-9 col-12 right_box">
            <a href="{{ url('admin/fabricweavervendor/manage-vendor') }}" class="dark-btn">+ Add Fabric Weaver Vendor</a>
        </div>
    </div>
            ...
            <div class="table-responsive" style="min-height:auto">
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        @php
                           $firms = \App\Models\FabricWeaverVendorFirm::where('fabric_weaver_vendor_id',$list->id)->get();
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{url('admin/fabricweavervendor/manage-vendor/')}}/{{$list->id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
     ...
     $(document).on("click",".del_popup2",function(){
        ...
        swal({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (willDelete) {
                $.ajax({
                    url:"{{ url('admin/fabricweavervendor/delete') }}",
                    method:"POST",
                    headers: {
