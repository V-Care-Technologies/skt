...
<div class="inner-main-content">   
    ...
    <div class="row align-items-center search_main_row mb-3">
        ...
        <div class="col-xl-9 col-md-9 col-12 right_box">
            <a href="{{ url('admin/rolainward/manage-rolainward') }}" class="dark-btn">+ Add Rola Inward</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{url('admin/rolainward/manage-rolainward/')}}/{{$list->id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
     ...
     $(document).on("click",".del_popup2",function(){
        ...
        swal({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (willDelete) {
                $.ajax({
                    url:"{{ url('admin/rolainward/delete') }}",
                    method:"POST",
                    headers: {
