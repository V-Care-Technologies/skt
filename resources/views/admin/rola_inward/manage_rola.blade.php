...
@section('page_title', 'Rola Inward')
@section('rola_system_select', 'active')
@section('rola_inward_select', 'inner_active')
...
<div class="inner-main-content">   
    <div class="main_page_heading">
        <h2><a href="{{ url('admin/rolainward') }}" class="back_btn"><i class="fa-solid fa-arrow-left"></i></a>
        @if($id != '0'){{"Update"}}@else{{"Add New"}}@endif Rola Inward</h2>
    </div>
    <div class="main_contact_form">
        <form action="" id="save-form" class="validate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="d-flex align-items-center justify-content-center mt-5 submit_row mb-5">
                <a href="{{ url('admin/rolainward') }}" class="cancel-btn">Cancel</a>
...
$(document).ready(function() {
    ...
    $(document).on("submit","#save-form",function(e){
        ...
        $.ajax({
            url:"{{ url('admin/rolainward/manage-rolainward-process') }}",
            method:"POST",
            ...
            success(response){
                ...
                if(obj.status=="1"){
                        ...
                        window.location.href = "{{ url('admin/rolainward') }}";
                }
                else {
