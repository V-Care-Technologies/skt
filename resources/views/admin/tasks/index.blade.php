...
<div class="inner-main-content">   
    ...
    <div class="row align-items-center search_main_row mb-3">
        ...
        <div class="col-xl-9 col-md-9 col-12 right_box">
            <a href="{{ url('admin/tasks/manage-tasks') }}" class="dark-btn">+ Add Tasks</a>
        </div>
    </div>
            ...
            <div class="table-responsive" style="min-height:auto">
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        @php
                            $status = $list->status == "1" ? "Pending" : "Closed";  
                            $priority = $list->priority == "1" ? "Low" : ($list->priority == "2" ? "Medium" : "High");                            
                        @endphp
                        <tr>
                            <td>
                            ...
                            <td class="name_box">
                                <p class="name">{{ date('d-m-Y',strtotime($list->created_at)) }}</p>
                            </td>
                            <td class="name_box">
                            ...
                            <td class="name_box">
                                <p class="name">{{ $list->labels }}</p>
                            </td>
                            <td class="name_box">
                                <p class="name">{{ $priority }}</p>
                            </td>
                            ...
                            <td class="action_td">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{url('admin/tasks/manage-tasks/')}}/{{$list->id}}">
