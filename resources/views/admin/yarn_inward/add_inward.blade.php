...
<div class="inner-main-content">   
    ...
    <div class="main_contact_form">
        <form action="" id="save-form" class="validate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="row">
                    ...
                    <div class="input_box">
                        ...
                        <select name="challan_id" id="yarn_challan_id" class="form-control yarn_challanid xx mySelect2" data-validate="required" data-message-required="Select challan name" required>
                            ...
                            <?php foreach($firms as $firm){?>
                                <option value="{{ $firm->id }}" >{{ $firm->vendor_name }}</option>
                            <?php }?>
                ...
                <div class="col-lg-3">
                    <div class="input_box">
                        ...
                        <input type="text" name="challan_no" id="challan_no" value="" placeholder="Enter challan_no" >
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="input_box">
                        ...
                        <input type="date" name="challan_date" value="" placeholder="Enter challan date" >
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="input_box">
                        <p>Received Date<span class="text-danger small">*</span></p>
                        <input type="date" name="received_date" value="" placeholder="Enter received date" >
                    </div>
                </div>
                                ...
                                <tr class="vendor-detail-row attri new">
                                    ...
                                    <td> 
                                        <div class="input_box">
                                            ...
                                            <input type="hidden" readonly name="yarn_po_detail_id[{{ $key1+1 }}]" id="yarn_po_detail_id{{ $key1+1 }}" value="{{ $item->id }}" class="yarn_po_detail_id" placeholder="#0000000">
                                    ...
                                    <td>
                                        <div class="input_box">
                                            <input type="number"  name="challan_qty[{{ $key1+1 }}]" id="challan_qty{{ $key1+1 }}" value="{{ $item->pqty }}" class="challan_qty" placeholder="Enter challan quantity">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input_box">
                                            <input type="number"  name="inward_qty[{{ $key1+1 }}]" id="inward_qty{{ $key1+1 }}" value="{{ $item->pqty }}" class="inward_qty" placeholder="Enter inward quantity">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input_box">
                                            <input type="number" readonly  name="weight_diff[{{ $key1+1 }}]" id="wt_diff{{ $key1+1 }}" value="0" class="wt_diff" placeholder="Enter wt diff">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input_box">
                                            <input type="number" readonly  name="weight_diff_per[{{ $key1+1 }}]" id="wt_diff_per{{ $key1+1 }}" value="0" class="wt_diff_per" placeholder="Enter wt diff per">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input_box">
            ...
            <input type="hidden" name="yarn_po_id" id="id" value="{{$id}}"/> 
