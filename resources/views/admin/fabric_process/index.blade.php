...
<div class="inner-main-content">   
    ...
    <div class="row align-items-center search_main_row mb-3">
        ...
        <div class="col-xl-9 col-md-9 col-12 right_box">
            <a href="{{ url('admin/fabricprocess/manage-fabricprocess') }}" class="dark-btn">+ Add Fabric Process</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{url('admin/fabricprocess/manage-fabricprocess/')}}/{{$list->id}}">
     ...
     $(document).on("click",".del_popup2",function(){
        ...
        swal({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (willDelete) {
                $.ajax({
                    url:"{{ url('admin/fabricprocess/delete') }}",
                    method:"POST",
                    headers: {
