...
<div class="inner-main-content">   
    ...
    <div class="row align-items-center search_main_row mb-3">
        ...
        <div class="col-xl-9 col-md-9 col-12 right_box">
            <a href="{{ url('admin/yarnbill/manage-bill') }}" class="dark-btn">+ Add Yarn Bill</a>
        </div>
    </div>
                ...
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="name_box">
                                <p class="name">{{ $list->bill_no }}</p>
                            </td>
                            <td class="name_box">
                                <p class="name">{{ $list->bill_date }}</p>
                            </td>
                            <td class="name_box">
                            ...
                            <td class="action_td">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{url('admin/yarnbill/manage-bill/')}}/{{$list->id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
