...
@section('page_title', 'Fabric Process Vendor')
@section('fabric_process_system_select', 'active')
@section('fabric_process_vendor_select', 'inner_active')
...
<div class="inner-main-content">   
    ...
    <div class="row align-items-center search_main_row mb-3">
        ...
        <div class="col-xl-9 col-md-9 col-12 right_box">
            <a href="{{ url('admin/fabricprocessvendor/manage-vendor') }}" class="dark-btn">+ Add Fabric Process Vendor</a>
        </div>
    </div>
                ...
                <table class="table" id="example">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Mobile No.(Follow - Up)</th>  
                    ...
                    <tbody>
                        ...
                        @php
                           $firms = \App\Models\FabricProcessVendorFirm::where('fabric_process_vendor_id',$list->id)->get();
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{url('admin/fabricprocessvendor/manage-vendor/')}}/{{$list->id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
     ...
     $(document).on("click",".del_popup2",function(){
        ...
        swal({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (willDelete) {
                $.ajax({
                    url:"{{ url('admin/fabricprocessvendor/delete') }}",
                    method:"POST",
                    headers: {
